...
object BuildWin : BuildType({
	...
	params {
        password("LICENSE_KEY", "credentialsJSON:c37dcc7e-597f-43f5-9b05-d9d8aeb9f5de", label = "License key", description = "Value to use for integrated Cinecoder license key", display = ParameterDisplay.HIDDEN)
    }
