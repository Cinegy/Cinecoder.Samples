...
public:
	...
	int Init(std::string filename, size_t iMaxCountDecoders = 2, bool useCuda = false, size_t gpuDevice = 1, size_t iScale = 0, IMAGE_FORMAT outputFormat = IMAGE_FORMAT_UNKNOWN);
